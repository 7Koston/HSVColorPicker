...
public class SaturationBar extends View {
  ...
  /**
   * Interface and listener so that changes in SaturationBar are sent to the host activity/fragment
   */
  ...
  private void init(AttributeSet attrs, int defStyle) {
    final TypedArray a =
        getContext().obtainStyledAttributes(attrs, R.styleable.SaturationBar, defStyle, 0);
    ...
    mBarLength =
        a.getDimensionPixelSize(
            R.styleable.SaturationBar_bar_length, b.getDimensionPixelSize(R.dimen.bar_length));
    ...
    mOrientation = a.getBoolean(R.styleable.SaturationBar_bar_orientation_horizontal, true);
