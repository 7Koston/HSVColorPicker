...
public class ValueBar extends View {
  ...
  /**
   * An array of floats that can be build into a {@code Color} <br> Where we can extract the color
   * from.
   */
  ...
  private void init(AttributeSet attrs, int defStyle) {
    final TypedArray a =
        getContext().obtainStyledAttributes(attrs, R.styleable.ValueBar, defStyle, 0);
    final Resources b = getContext().getResources();

    mBarThickness =
        a.getDimensionPixelSize(
            R.styleable.ValueBar_bar_thickness, b.getDimensionPixelSize(R.dimen.bar_thickness));
    mBarLength =
        a.getDimensionPixelSize(
            R.styleable.ValueBar_bar_length, b.getDimensionPixelSize(R.dimen.bar_length));
    mPreferredBarLength = mBarLength;
    mBarPointerRadius =
        a.getDimensionPixelSize(
            R.styleable.ValueBar_bar_pointer_radius,
            b.getDimensionPixelSize(R.dimen.bar_pointer_radius));
    mBarPointerHaloRadius =
        a.getDimensionPixelSize(
            R.styleable.ValueBar_bar_pointer_halo_radius,
            b.getDimensionPixelSize(R.dimen.bar_pointer_halo_radius));
    mOrientation = a.getBoolean(R.styleable.ValueBar_bar_orientation_horizontal, true);
    ...
    if (!isInEditMode()) {
      ...
      shader =
          new LinearGradient(
              ...
              x1,
              y1,
              new int[]{0xff81ff00, Color.BLACK},
              null,
              Shader.TileMode.CLAMP);
  ...
  public void setValue(float value) {
    mBarPointerPosition =
        Math.round((mBarLength - (mSatToPosFactor * value)) + mBarPointerHaloRadius);
  ...
  private void calculateColor(int coord) {
    ...
    mColor =
        Color.HSVToColor(new float[]{mHSVColor[0], mHSVColor[1], 1 - (mPosToSatFactor * coord)});
  }
