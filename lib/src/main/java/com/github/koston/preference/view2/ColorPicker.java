 ...
 *
 * <p>
 * Use {@link #getColor()} to retrieve the selected color. <br> Use {@link
 * #addOpacityBar(OpacityBar)} to add a Opacity Bar.
 * </p>
 */
public class ColorPicker extends View {
   ...
   *
   * <p>
   * We use the center of this (quadratic) View as origin of our internal coordinate system. Android
   * uses the upper left corner as origin for the View-specific coordinate system. So this is the
   * value we use to translate from one coordinate system to the other.
   * </p>
   *
   * <p>
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    mColorCenterHaloRadius = (int) ((float) mPreferredColorCenterHaloRadius * (
